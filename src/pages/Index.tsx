...
const Index = () => {
  ...
  const showWordDetails = (word: string, definition: string) => {
    ...
    console.log(`Show details for ${word}: ${definition}`);
  };
        ...
        <div className="mb-6">
          <div className="relative h-64 mb-4">
            ...
            <div className="absolute top-0 left-0 flex gap-4 p-4 text-gray-500 z-10">
              ...
              >
                <i className="ri-text-line w-5 h-5 flex items-center justify-center"></i>
                Text
              </Button>
              <Button
                type="button"
              ...
              >
                <i className="ri-link w-5 h-5 flex items-center justify-center"></i>
                URL
              </Button>
              <Button
                type="button"
            ...
            {/* Analyze button */}
            <Button
              className="absolute bottom-4 right-4 px-8 py-3 h-auto bg-primary text-white font-medium rounded-button hover:bg-primary/90"
            >
              Analyze Vocabulary
            </Button>
          </div>
